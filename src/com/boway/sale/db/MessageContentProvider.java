...
public class MessageContentProvider extends ContentProvider {
	...
	public static final String DATA_PROVIDER = "content://com.boway.saleservice.data.provider";
	private static final int DATABASE_VERSION = 1;
	private static final String DATABASE_NAME = "imei_sent.db3";
	private static final String EXECUTE_CREATE_SQL = "create table if not exists imei " +
	...
	public Uri insert(Uri uri, ContentValues contentValues) {
        ...
        try{
	        long id = sdb.insert("imei", null, contentValues);
	        if(id > 0){
	...
	public Cursor query(Uri arg0, String[] arg1, String arg2, String[] arg3,
			String arg4) {
		return sdb.query("imei", null, null, null, null, null,null);
	}

	@Override
	public int update(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
		return sdb.update("imei", contentValues, selection, selectionArgs);
	}
